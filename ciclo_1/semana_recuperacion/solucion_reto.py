def AutoPartes(ventas: list):
    ...
    for idProducto, dProducto, pnProducto, cvProducto, sProducto, \
        ...
        if dictVenta.get(idProducto) == None:
            #Creación de item
            dictVenta[idProducto] = []

        # Registro de una nueva lista de tuplas
        dictVenta[idProducto].append((dProducto,pnProducto,cvProducto, \
    ...
    if idProducto in ventas:
        for dProducto, pnProducto, cvProducto, sProducto, nComprador, \
            ...
            print('Producto consultado : ', idProducto, ' Descripción ', dProducto, \
                ' #Parte ', pnProducto, ' Cantidad vendida ', cvProducto, \
                ' Stock ', sProducto, ' Comprador', nComprador, \
                ' Documento ', cComprador, ' Fecha Venta ',fVenta)
    else:
        # Si no se ubica el idProducto
